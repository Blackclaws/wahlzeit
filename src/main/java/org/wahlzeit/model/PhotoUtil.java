...
public class PhotoUtil {
	 ...
	 * @methodtype creation
	 */
	public static AnimePhoto createPhoto(String filename, PhotoId id, Image uploadedImage) throws Exception {
		AnimePhoto result = PhotoFactory.getInstance().createPhoto(id);
